...
See also the <Link href="/quad-ref">quad ref</Link> for more details on Ibzan&rsquo;s quad form, and the <Link href="/collar-ref">collar ref</Link> for details on his collar.
...
These six colours form the core of Ibzan&rsquo;s fur patterns.
Other things, such as clothes, don&rsquo;t need to be precise.
