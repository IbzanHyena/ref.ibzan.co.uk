...
The <Link href="/">main reference</Link> covers these in more detail, but, in short:
...
Some key elements of hyena anatomy and Ibzan&rsquo;s design as a feral to keep and eye on are as follows.
...
For details on the collar, see the <Link href="/collar-ref">collar ref</Link>.
